...
// Minimal, professional icons for micro-SaaS
...
export function SecurityShieldIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FederalBadgeIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ComplianceCheckmarkIcon({ className, size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
