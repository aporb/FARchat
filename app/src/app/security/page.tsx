...
export default function SecurityPage() {
    return (
        <>
            <Navigation />
            <PageBackground variant="network" overlay="light" imageOpacity={0.04}>
                <div className="pt-20 pb-16">
                                ...
                                {securitySections.map((section) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4 mb-6">
                                            <div className="w-12 h-12 rounded-xl bg-blue-500/20 dark:bg-blue-500/30 backdrop-blur-sm flex items-center justify-center">
                    ...
                    <section className="py-12 md:py-16">
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
                            <GlassCard variant="heavy" className="p-6 md:p-8 border-amber-200/50 dark:border-amber-800/50 bg-amber-50/60 dark:bg-amber-900/20">
                                <div className="flex flex-col md:flex-row md:items-start gap-6">
                                    <div className="w-12 h-12 rounded-xl bg-amber-500/20 dark:bg-amber-500/30 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4">
                                            <Button asChild className="bg-slate-900 hover:bg-slate-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white">
